...
// Shared types remain aliases so existing application message switches keep working.
type (
	Dialog             = common.Dialog
	OpenDialogMsg      = common.OpenDialogMsg
	CloseDialogMsg     = common.CloseDialogMsg
	CloseAllDialogsMsg = common.CloseAllDialogsMsg
	Broadcastable      = common.Broadcastable
)
