...
// SortStableFunc recognizes side-effect-free integer/string key comparisons.
var SortStableFunc = &cop.Func{
	Meta: cop.Meta{
		Name:        "Lint/SortStableFunc",
		Description: "use slices.SortStableFunc with cmp.Compare instead of reflection-based sorting",
