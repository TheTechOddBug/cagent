...
// ReflectFields covers paired metadata/value loops not handled by stditerators.
var ReflectFields = modernizationCop(reflectFieldsFile)

var reflectFieldsFile = &cop.Func{
	Meta: cop.Meta{
		Name:        "Lint/ReflectFields",
		Description: "use reflect.Value.Fields for paired field metadata and values",
