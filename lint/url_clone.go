...
// URLClone requires resolved URL types, including aliased imports and types.
var URLClone = modernizationCop(urlCloneFile)

var urlCloneFile = &cop.Func{
	Meta: cop.Meta{
		Name:        "Lint/URLClone",
		Description: "use url.URL.Clone for equivalent manual deep copies",
