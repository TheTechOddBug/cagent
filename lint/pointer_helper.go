...
// PointerHelper covers AWS forwarding wrappers missed by modernize's new-like facts.
var PointerHelper = modernizationCop(pointerHelperFile)

var pointerHelperFile = &cop.Func{
	Meta: cop.Meta{
		Name:        "Lint/PointerHelper",
		Description: "use new expressions instead of AWS scalar pointer helpers",
