...
// NewExpr catches fresh temporaries used only to return their address. Requiring
// adjacent statements and constant companion results preserves evaluation order.
var NewExpr = &cop.Func{
	Meta: cop.Meta{
		Name:        "Lint/NewExpr",
		Description: "use new(expr) instead of a temporary declared only to return its address",
